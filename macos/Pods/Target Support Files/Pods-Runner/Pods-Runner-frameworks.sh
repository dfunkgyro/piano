...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_midi_command/flutter_midi_command.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/universal_ble/universal_ble.framework"
