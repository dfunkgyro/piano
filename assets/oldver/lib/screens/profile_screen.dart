...
// Update the _signOut method:
    ...
    return CupertinoPageScaffold(
      ...
      child: SafeArea(
        child: _isLoading
            ...
            : _profile == null
                ? (widget.guestMode ? _buildGuestProfile() : _buildSignInPrompt())
                : _buildProfile(),
      ),
    );
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text(
            'You have full access without signing in.',
          ...
          CupertinoButton(
            onPressed: () {
              Navigator.of(context).push(
                CupertinoPageRoute(
                  builder: (_) => const ErrorReportsScreen(),
                ),
              );
            },
            child: const Text('Crash Reports'),
          ),
        ],
      ),
    );
  ...
  void _showSettings() {
    showCupertinoDialog(
      ...
      builder: (context) => CupertinoAlertDialog(
        title: const Text('Settings'),
        content: const Text('Adjust app settings and preferences.'),
        actions: [
          CupertinoDialogAction(
            child: const Text('OK'),
            onPressed: () => Navigator.pop(context),
