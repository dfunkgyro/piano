...
class _ConnectionStatusPanelState extends State<ConnectionStatusPanel> {
  ...
  Widget _buildEmptyView() {
    ...
    final lastErrorDetail = widget.midiService.lastScanErrorDetail;
    final bridgeConnected =
        widget.midiService.getDebugStats()['bridgeConnected'] == true;
    final needsSettings = !kIsWeb &&
        lastError != null &&
            ...
            if (kIsWeb && !bridgeConnected) ...[
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      'Windows BLE-MIDI Bridge Required',
                      style: TextStyle(fontWeight: FontWeight.bold),
                    ),
                    const SizedBox(height: 6),
                    const Text(
                      'Chrome blocks BLE-MIDI directly. Install the bridge app, run it, and connect your device there.',
                    ...
                    CupertinoButton(
                      padding: EdgeInsets.zero,
                      onPressed: () => openUrl(
                        'https://piano.thegyromusic.com/bridge/bridge-win.zip',
                      ),
                      child: const Text('Download Bridge (Windows)'),
                    ),
                    const SizedBox(height: 6),
                    const Text(
                      'After downloading: unzip, run `bridge.exe`, click Scan, then Connect.',
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (lastErrorDetail != null) ...[
                      const SizedBox(height: 6),
                      SelectableText('Details: $lastErrorDetail'),
                    ],
                    const SizedBox(height: 8),
                    CupertinoButton(
                      padding: EdgeInsets.zero,
                      onPressed: () {
                        final text = lastErrorDetail != null
