...
import '../utils/lesson_generator.dart';
...
class ScoreLessonScreen extends StatefulWidget {
  final Song song;
  const ScoreLessonScreen({super.key, required this.song});

  @override
  State<ScoreLessonScreen> createState() => _ScoreLessonScreenState();
}

class _ScoreLessonScreenState extends State<ScoreLessonScreen> {
  ...
  void initState() {
    super.initState();
    _rawNotes = LessonGenerator.generate(widget.song);
